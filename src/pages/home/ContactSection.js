...
export default function ContactSection() {
  return (
    <SectionComponent id="contacts">
      <div className="lg:grid xl:grid grid-rows-1 lg:grid-cols-3 xl:grid-cols-3 grid-flow-row gap-20">
        ...
        <div className="my-auto">
          <div className="mb-8 text-xl font-bold text-black break-all">{SUPPORT_EMAIL}</div>
